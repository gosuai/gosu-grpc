...
from gosu_grpc.google.cloud.dialogflow.v2 import intent_pb2 as google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2
...
class Intents(object):
    ...
    *   **Training phrases** - provide examples of user input to train the
    ...
    def ListIntents(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dialogflow.v2.Intents/ListIntents',
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.ListIntentsRequest.SerializeToString,
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.ListIntentsResponse.FromString,
    ...
    def GetIntent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dialogflow.v2.Intents/GetIntent',
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.GetIntentRequest.SerializeToString,
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.Intent.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CreateIntent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dialogflow.v2.Intents/CreateIntent',
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.CreateIntentRequest.SerializeToString,
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.Intent.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateIntent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dialogflow.v2.Intents/UpdateIntent',
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.UpdateIntentRequest.SerializeToString,
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.Intent.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteIntent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dialogflow.v2.Intents/DeleteIntent',
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.DeleteIntentRequest.SerializeToString,
    ...
    def BatchUpdateIntents(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dialogflow.v2.Intents/BatchUpdateIntents',
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.BatchUpdateIntentsRequest.SerializeToString,
    ...
    def BatchDeleteIntents(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.dialogflow.v2.Intents/BatchDeleteIntents',
            google_dot_cloud_dot_dialogflow_dot_v2_dot_intent__pb2.BatchDeleteIntentsRequest.SerializeToString,
            google_dot_longrunning_dot_operations__pb2.Operation.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
