...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/dialogflow/v2/validation_result.proto',
...
_VALIDATIONERROR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='severity', full_name='google.cloud.dialogflow.v2.ValidationError.severity', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='entries', full_name='google.cloud.dialogflow.v2.ValidationError.entries', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error_message', full_name='google.cloud.dialogflow.v2.ValidationError.error_message', index=2,
...
_VALIDATIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='validation_errors', full_name='google.cloud.dialogflow.v2.ValidationResult.validation_errors', index=0,
